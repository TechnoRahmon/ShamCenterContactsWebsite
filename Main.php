        ...
        <div class="sideA">
            <form method="POST">
                <button id="Erase" onclick="EraseBoxes()">
                    <i class="fa fa-close"></i>إفراغ</button>
                <input type="text" name="FirstName" id="Fname" placeholder="الاسم الاول" autocomplete="off">
                <br>
                <input type="text" name="LastName" id="Lname" placeholder="الاسم الثاني" autocomplete="off">
                <br>
                <input type="text" name="PersNum" id="PsNum" placeholder="الرقم الشخصي" autocomplete="off">
                <br>
                <input type="text" name="Adress" id="Adress" placeholder="العنوان" autocomplete="off">
                <br>
                <input type="text" name="PostNum" id="PoNum" placeholder="الرمز البريدي" autocomplete="off">
                <br>
                <input type="text" name="MobNum" id="MbNum" placeholder="رقم الهاتف" autocomplete="off">
                <br>
                <input type="text" name="Email" id="Email" placeholder="الايميل" autocomplete="off">
                <br>
                ...
                <button type="submit" name="submit" formaction="Methodes\InsertData.php">
                    <i class="fa fa-plus" aria-hidden="true"></i>اضافة</button>
                <button type="submit" name="Update" onclick="CheckForUserId()" formaction="Methodes\UpdataData.php">
                    <i class="fa fa-repeat" aria-hidden="true"></i>تعديل</button>
                <button type="submit" name="Delete" onclick="CheckForUserId()" formaction="Methodes\DeleteData.php"><i class="fa fa-trash"></i>حذف</button>
                <button type="button" name="PrintUser" onclick="Printuser()">
                    <i class="fa fa-download" aria-hidden="true"></i>إخراج العضو</button>
                <button type="button" name="PrintAll" onclick="Printall()">
                    <i class="fa fa-print" aria-hidden="true"></i>إخراج الكل</button>
            </form>
        </div>

        <div class="sideB">
            <form id="searchB">
                <input type="text" id="SerachBox" onkeyup="SreachFilter()" placeholder="البحث" autocomplete="off">
            </form>
